  ...
  return (
    <div className="flex items-center">
      <button
        ...
        type="button"
        className={`${
          props.inReview ? "bg-red-600" : "bg-gray-200"
      ...
      <span className="ml-3" id="annual-billing-label">
        <span className="text-sm font-medium text-gray-900">This will hide the user input table above </span>
        <span className="text-sm text-gray-500">
          (Toggle to show the inputs again)
        </span>
      </span>
    </div>
  );

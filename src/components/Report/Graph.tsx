...
interface IProps {
  scheduleSummary: any[];
  setGraphImage: (image: string) => void;
}
...
const Graph: React.FC<IProps> = ({ scheduleSummary, setGraphImage }) => {
  
  
 
  return (
    <div id="to-print" className="container mx-auto m-6 ">

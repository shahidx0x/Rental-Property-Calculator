...
export default function CashFlowSection({
  ...
  useEffect(() => {
    localStorage.setItem("cleanCashFlow", formatNumberAsCurrency(cleanCashFlow, 2));
    localStorage.setItem("cleanIncome", formatNumberAsCurrency(cleanIncome, 2));
    localStorage.setItem("cleanExpense", formatNumberAsCurrency(cleanExpense, 2));
    localStorage.setItem("totalMonthlyIncome", formatNumberAsCurrency(totalMonthlyIncome, 2));
    localStorage.setItem("halfPercentMonthlyExpense", formatNumberAsCurrency(halfPercentMonthlyExpense, 2));
    localStorage.setItem("calculateMortgage", formatNumberAsCurrency(calculateMortgage, 2));
    localStorage.setItem("halfPercentRuleCashFlow", formatNumberAsCurrency(halfPercentRuleCashFlow, 2));
  }, [cleanCashFlow, cleanIncome, cleanExpense, totalMonthlyIncome, halfPercentMonthlyExpense, calculateMortgage, halfPercentRuleCashFlow]);

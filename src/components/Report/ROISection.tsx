...
export default function ROISection({
  ...
  useEffect(() => {
    localStorage.setItem("netOperatingIncome", formatNumberAsCurrency(netOperatingIncome, 2));
    localStorage.setItem("cashOnCashReturn", formatNumberAsCurrency(cashOnCashReturn, 2));
    localStorage.setItem("proFormaCap", formatNumberAsCurrency(proFormaCap, 2));
    localStorage.setItem("purchaseCap", formatNumberAsCurrency(purchaseCap, 2));
  }, [netOperatingIncome, cashOnCashReturn, proFormaCap, purchaseCap]);
  return (
    <div>
      <div>
